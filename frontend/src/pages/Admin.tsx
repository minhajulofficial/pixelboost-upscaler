                  ...
                  filtered.map((u) => (
                    <tr key={u.user_id} className="border-t border-gray-800">
                      <td className="px-4 py-3">
                        <div className="max-w-[220px] truncate text-sm font-medium text-white" title={u.email || ''}>
                          {u.email || '—'}
                        </div>
                      </td>
                      <td className="px-4 py-3">
                ...
                {payments.length === 0 ? (
                  ...
                  payments.map((p) => (
                    <tr key={p.id} className="border-t border-gray-800">
                      ...
                      <td className="px-4 py-3 text-sm text-white">{users.find((u) => u.user_id === p.user_id)?.email || '—'}</td>
