    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="hidden w-1/2 lg:flex lg:flex-col lg:items-center lg:justify-center bg-gradient-to-br from-green-600 to-emerald-700 p-12">
        <div className="max-w-md text-white">
          ...
          <h1 className="mb-4 text-4xl font-bold leading-tight">Upscale images with AI power</h1>
          <p className="mb-10 text-lg text-green-100">2x–6x AI upscaling. Free to start. No watermarks.</p>
      ...
      <div className="flex w-full items-center justify-center p-6 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <p className="mb-8 text-sm text-gray-500 dark:text-gray-400">Sign in to your account</p>
